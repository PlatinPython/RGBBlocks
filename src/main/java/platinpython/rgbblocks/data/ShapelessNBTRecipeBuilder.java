...
public class ShapelessNBTRecipeBuilder {
	...
	public static class Result implements FinishedRecipe {
		...
		public Result(ResourceLocation id, Item result, int count, CompoundTag compound, String group, List<Ingredient> ingredients, Advancement.Builder advancementBuilder, ResourceLocation advancementId, boolean isNoReturnRecipe) {
			this.id = id;
			this.result = result;
			this.count = count;
			this.compound = compound;
