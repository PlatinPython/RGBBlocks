...
public class ModRecipeProvider extends RecipeProvider implements IConditionBuilder {
    ...
    protected void buildShapelessRecipes(Consumer<IFinishedRecipe> consumer) {
        ...
        RegistryHandler.BLOCKS.getEntries()
                              .forEach((block) -> ShapelessNBTRecipeBuilder.shapeless(block.get().getBlock())
                                                                           .requires(block.get())
    ...
    private void block(Consumer<IFinishedRecipe> consumer, Block result, Ingredient ingredient) {
        ShapelessNBTRecipeBuilder.shapeless(result.getBlock())
                                 .requires(ingredient)
                                 .requires(ItemRegistry.PAINT_BUCKET.get())
    ...
    private void slabBlock(Consumer<IFinishedRecipe> consumer, Block result, Block base) {
        ShapedNBTRecipeBuilder.shaped(result.getBlock(), 6, whiteNBT)
                              .define('#', base.getBlock())
                              .pattern("###")
    ...
    private void stairBlock(Consumer<IFinishedRecipe> consumer, Block result, Block base) {
        ShapedNBTRecipeBuilder.shaped(result.getBlock(), 4, whiteNBT)
                              .define('#', base.getBlock())
                              .pattern("#  ")
                              .pattern("## ")
                              .pattern("###")
