...
public class RGBFlatStairsBlock extends StairsBlock {
	public RGBFlatStairsBlock() {
		super(() -> BlockRegistry.RGB_FLAT.get().getDefaultState(), Block.Properties.create(new Material.Builder(MaterialColor.AIR).build()));
	}
