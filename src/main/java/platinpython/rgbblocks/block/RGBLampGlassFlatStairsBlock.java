...
public class RGBLampGlassFlatStairsBlock extends StairsBlock {
	public RGBLampGlassFlatStairsBlock() {
		super(() -> BlockRegistry.RGB_LAMP_GLASS_FLAT.get().getDefaultState(),
