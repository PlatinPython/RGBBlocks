...
public class RGBLampFlatStairsBlock extends StairsBlock {

	public RGBLampFlatStairsBlock() {
		super(() -> BlockRegistry.RGB_LAMP_FLAT.get().getDefaultState(), Block.Properties.create(new Material.Builder(MaterialColor.AIR).build()));
	}
