...
public class ColorSlider extends AbstractSlider {
	...
	protected void applyValue() {
		...
		if (minecraft.screen instanceof ColorSelectScreen) {
			...
			screen.hexField.setValue("#" + Integer.toHexString(new Color(screen.redSlider.getValueInt(), screen.greenSlider.getValueInt(), screen.	blueSlider.getValueInt()).getRGB()).substring(2).toUpperCase(Locale.ENGLISH));
		}
	}
