    ...
    protected void init() {
        ...
        if (redSlider == null) {
            this.redSlider = new ColorSlider(x,
                                             ...
                                             SLIDER_WIDTH,
                                             WIDGET_HEIGHT,
                                             new TranslationTextComponent("gui.rgbblocks.red").append(": "),
                                             MIN_VALUE,
                                             MAX_VALUE_RGB,
                                             this.red,
                                             SliderType.RED);
        ...
        if (hueSlider == null) {
            this.hueSlider = new ColorSlider(x,
                                             ...
                                             SLIDER_WIDTH,
                                             WIDGET_HEIGHT,
                                             new TranslationTextComponent("gui.rgbblocks.hue").append(": "),
                                             MIN_VALUE,
                                             MAX_VALUE_HUE,
                                             this.hue,
                                             SliderType.HUE);
        ...
        if (greenSlider == null) {
            this.greenSlider = new ColorSlider(x,
                                               ...
                                               SLIDER_WIDTH,
                                               WIDGET_HEIGHT,
                                               new TranslationTextComponent("gui.rgbblocks.green").append(": "),
                                               MIN_VALUE,
                                               MAX_VALUE_RGB,
                                               this.green,
                                               SliderType.GREEN);
        ...
        if (saturationSlider == null) {
            this.saturationSlider = new ColorSlider(x,
                                                    ...
                                                    SLIDER_WIDTH,
                                                    WIDGET_HEIGHT,
                                                    new TranslationTextComponent("gui.rgbblocks.saturation").append(": "),
                                                    MIN_VALUE,
                                                    MAX_VALUE_SB,
                                                    this.saturation,
        ...
        if (blueSlider == null) {
            this.blueSlider = new ColorSlider(x,
                                              ...
                                              SLIDER_WIDTH,
                                              WIDGET_HEIGHT,
                                              new TranslationTextComponent("gui.rgbblocks.blue").append(": "),
                                              MIN_VALUE,
                                              MAX_VALUE_RGB,
                                              this.blue,
                                              SliderType.BLUE);
        ...
        if (brightnessSlider == null) {
            this.brightnessSlider = new ColorSlider(x,
                                                    ...
                                                    SLIDER_WIDTH,
                                                    WIDGET_HEIGHT,
                                                    new TranslationTextComponent("gui.rgbblocks.brightness").append(": "),
                                                    MIN_VALUE,
                                                    MAX_VALUE_SB,
                                                    this.brightness,
        ...
        this.hexField = new TextFieldWidget(this.font,
                                            x,
                                            y,
                                            FIELD_WIDTH,
                                            WIDGET_HEIGHT,
                                            new StringTextComponent("Hex")) {
        ...
        ExtendedButton toggleButton = new ExtendedButton(x,
                                                         y,
                                                         BUTTON_WIDTH,
                                                         WIDGET_HEIGHT,
                                                         ...
                                                         button -> {
                                                             ...
                                                             if (isRGBSelected) {
                                                                 Color color = Color.getHSBColor((float) (hueSlider.getValueInt() /
                                                                                                          MAX_VALUE_HUE),
                                                                                                 (float) (
                                                                                                         saturationSlider.getValueInt() /
                                                                                                         MAX_VALUE_SB),
                                                                                                 (float) (
                                                                                                         brightnessSlider.getValueInt() /
                                                                                                         MAX_VALUE_SB));
                                                                 ...
                                                                 saturationSlider.setValueInt((int) (hsb[1] *
                                                                                                     MAX_VALUE_SB));
                                                                 brightnessSlider.setValueInt((int) (hsb[2] *
                                                                                                     MAX_VALUE_SB));
