...
public class RecipeSerializerRegistry {
    public static final DeferredHolder<RecipeSerializer<?>, ShapelessNoReturnRecipe.Serializer> SHAPELESS_NO_RETURN_RECIPE =
        RegistryHandler.RECIPE_SERIALIZERS
            .register("crafting_shapeless_no_return", ShapelessNoReturnRecipe.Serializer::new);

    public static final DeferredHolder<RecipeSerializer<?>, ShapelessDurabilityAwarePaintBucketRecipe.Serializer> SHAPELESS_DURABILITY_AWARE_PAINT_BUCKET_RECIPE =
