...
public class BlockRegistry {
    public static final RegistryObject<RGBBlock> RGB_CONCRETE = register("concrete", () -> new RGBBlock(
    ...
    public static final RegistryObject<RGBConcretePowderBlock> RGB_CONCRETE_POWDER = register("concrete_powder",
                                                                                              RGBConcretePowderBlock::new
    );

    public static final RegistryObject<RGBBlock> RGB_WOOL = register("wool", () -> new RGBBlock(
            Properties.copy(Blocks.WHITE_WOOL)));
    public static final RegistryObject<RGBSlabBlock> RGB_WOOL_SLAB = register("wool_slab", () -> new RGBSlabBlock(
            Properties.copy(Blocks.WHITE_WOOL)));
    ...
    public static final RegistryObject<RGBBlock> RGB_PLANKS = register("planks", () -> new RGBBlock(
            Properties.copy(Blocks.BIRCH_PLANKS)));
    public static final RegistryObject<RGBSlabBlock> RGB_PLANKS_SLAB = register("planks_slab", () -> new RGBSlabBlock(
            Properties.copy(Blocks.BIRCH_PLANKS)));
    ...
    public static final RegistryObject<RGBBlock> RGB_TERRACOTTA = register("terracotta", () -> new RGBBlock(
    ...
    public static final RegistryObject<RGBGlassSlabBlock> RGB_GLASS_SLAB = register("glass_slab",
                                                                                    RGBGlassSlabBlock::new
    );
    public static final RegistryObject<RGBGlassStairsBlock> RGB_GLASS_STAIRS = register("glass_stairs",
                                                                                        () -> new RGBGlassStairsBlock(
                                                                                                () -> RGB_GLASS.get()
                                                                                                               .defaultBlockState())
    );
    ...
    public static final RegistryObject<RGBBlock> RGB_ANTIBLOCK = register("antiblock", () -> new RGBBlock(
            Properties.copy(Blocks.STONE)));

    public static final RegistryObject<RGBBlock> RGB_GLOWSTONE = register("glowstone", () -> new RGBBlock(
            Properties.copy(Blocks.GLOWSTONE)));

    public static final RegistryObject<RGBRedstoneLampBlock> RGB_REDSTONE_LAMP = register("redstone_lamp",
                                                                                          RGBRedstoneLampBlock::new
    );

    public static final RegistryObject<RGBBlock> RGB_PRISMARINE = register("prismarine", () -> new RGBBlock(
            Properties.copy(Blocks.PRISMARINE)));
    ...
    public static final RegistryObject<RGBStairsBlock> RGB_PRISMARINE_STAIRS = register("prismarine_stairs",
                                                                                        () -> new RGBStairsBlock(
                                                                                                RGB_PRISMARINE.get()::defaultBlockState,
                                                                                                Properties.copy(
    ...
    public static final RegistryObject<RGBStairsBlock> RGB_PRISMARINE_BRICK_STAIRS = register(
            "prismarine_bricks_stairs", () -> new RGBStairsBlock(RGB_PRISMARINE_BRICKS.get()::defaultBlockState,
                                                                 Properties.copy(Blocks.PRISMARINE_BRICK_STAIRS)
            ));


    public static final RegistryObject<RGBBlock> RGB_DARK_PRISMARINE = register("dark_prismarine", () -> new RGBBlock(
            Properties.copy(Blocks.DARK_PRISMARINE)));
    ...
    public static final RegistryObject<RGBBlock> RGB_SEA_LANTERN = register("sea_lantern", () -> new RGBBlock(
            Properties.copy(Blocks.SEA_LANTERN)));
