...
public class EntityRegistry {
	public static final RegistryObject<EntityType<RGBFallingBlockEntity>> RGB_FALLING_BLOCK = RegistryHandler.ENTITY_TYPES
			.register("rgb_falling_block",
					() -> EntityType.Builder
							.<RGBFallingBlockEntity>of(RGBFallingBlockEntity::new, EntityClassification.MISC)
